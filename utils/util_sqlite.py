...
def excute_sqlite_sql(sql, param=None, should_print=False):
    ...
    try:
        ...
        print(f"excute_sqlite_sql: An error occurred: {e}")
        return None
...
def initialize_database():
    ...
    try:
        ...
        print(f"initialize_database: An error occurred: {e}")

def check(platform, video_name, should_print=False):
    ans = excute_sqlite_sql(config.table_select_name_count_sql, (platform, video_name), should_print)
